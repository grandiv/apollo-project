// It will map to: /create/courseId
...
const ConfirmCreateCourse = async ({ params: { courseId } }: Props) => {
  ...
  const course = await prisma.course.findUnique({
    ...
    // to include the units and chapters in the response instead of just the course
    include: {
      units: {
        include: {
          chapters: true,
